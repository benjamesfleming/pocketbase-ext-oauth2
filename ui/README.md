...
This UI uses Alpine.js for simplicity and to avoid needing a build step. It is embedded directly into the plugin's Go code and served as static assets. The UI is passed props via a base64url-encoded state parameter in the query strings.
